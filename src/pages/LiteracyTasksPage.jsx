// src/pages/LiteracyTasksPage.jsx
...
const LiteracyTasksPage = () => {
    ...
    useEffect(() => {
        api.getTasks({ subject: 'literacy', language: i18n.language, level })
            .then(data => {
...
export default LiteracyTasksPage;
