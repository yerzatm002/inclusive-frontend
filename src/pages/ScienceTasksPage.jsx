// src/pages/ScienceTasksPage.jsx
...
const ScienceTasksPage = () => {
  ...
  useEffect(() => {
    api.getTasks({ subject: 'science', language: i18n.language, level })
      .then(data => {
        console.log('Fetched science tasks:', data);
        setTasks(data);
      })
      .catch(console.error);
  }, [i18n.language, level]);
...
export default ScienceTasksPage;
